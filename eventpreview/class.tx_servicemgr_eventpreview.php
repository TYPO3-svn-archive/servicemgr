 ...
 */
class tx_servicemgr_eventpreview extends tslib_pibase {
	var $prefixId      = 'tx_servicemgr_eventpreview';		// Same as class name
	var $scriptRelPath = 'eventpreview/class.tx_servicemgr_eventpreview.php';	// Path to this script relative to the extension dir.
	...
	function main($content,$conf)	{
		...
		$this->pi_loadLL();
		$this->tx_servicemgr->tx_loadLL($this->LOCAL_LANG);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/servicemgr/eventpreview/class.tx_servicemgr_eventpreview.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/servicemgr/eventpreview/class.tx_servicemgr_eventpreview.php']);
}
