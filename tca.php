...
$TCA['tx_servicemgr_events'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'sys_language_uid,l18n_parent,l18n_diffsource,hidden,datetime,subject,subtitle,public,series,tags,requiredteams,dutyscheduleopen,documents,audiofiles,notes,notes_internal'
	),
	...
	'columns' => array (
		...
		'inpreview' => array (
			'exclude' => 1,
			'label'   => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_events.inpreview',
			'config'  => array (
				'type'    => 'check',
				'default' => '1'
			)
		...
		'subtitle' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_events.subtitle',
			'config' => Array (
				'type' => 'input',
				'size' => '30',
				'eval' => 'trim',
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden, inpreview;;1, datetime, subject, subtitle, public, series, tags, requiredteams, dutyscheduleopen, documents, notes, notes_internal')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
...
$TCA['tx_servicemgr_series'] = array (
	...
	'columns' => array (
		...
		'colorscheme' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_series.colorscheme',
			'config' => Array (
				'type' => 'input',
				'size' => '30',
				'eval' => 'trim',
...
$TCA['tx_servicemgr_tags'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'sys_language_uid,l18n_parent,l18n_diffsource,hidden,name,parent'
	),
	...
	'columns' => array (
		...
		'parent' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_tags.parent',
			'config' => Array (
				'type' => 'select',
				'items' => Array (
					Array('',0),
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, name, parent')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
...
$TCA['tx_servicemgr_sermons'] = array (
	...
	'interface' => array (
		'showRecordFieldList' => 'sys_language_uid,l18n_parent,l18n_diffsource,hidden,event,title,subtitle,scripture,summary,file,filedate,playtime,bitrate,album'
	),
	...
	'columns' => array (
		...
		'subtitle' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_sermons.subtitle',
			'config' => Array (
				'type' => 'input',
				'size' => '50',
				'eval' => 'trim',
		...
		'scripture' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_sermons.scripture',
			'config' => Array (
				'type' => 'input',
				'size' => '30',
				'eval' => 'trim',
		...
		'summary' => Array (
			'exclude' => 1,
			'label' => 'LLL:EXT:servicemgr/locallang_db.xml:tx_servicemgr_sermons.summary',
			'config' => Array (
				'type' => 'text',
				'cols' => '30',
				'rows' => '5',
	...
	'types' => array (
		'0' => array('showitem' => 'sys_language_uid;;;;1-1-1, l18n_parent, l18n_diffsource, hidden;;1, title;;;;2-2-2, subtitle, scripture, summary, file;;;;3-3-3, filedate, playtime, filesize, bitrate, album')
	),
	'palettes' => array (
		'1' => array('showitem' => '')
	)
